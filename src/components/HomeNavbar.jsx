...
function Navbar() {
  ...
  return (
    ...
    <div className={!scrolled ? 'homenavbar' : 'homenavbar_scrolled'}>
      <div className='navbar-container'>
        <div className='navbar-logo' style={{fill:'white'}}>
         <svg style={{width:'250px',padding:'10px'}} version="1.1" x="0px" y="0px" viewBox="0 0 400 50">
       ...
       <Button onClick={logout} variant='danger' style={{backgroundColor:'transparent',color:'#fff',border:'1px solid #fff'}} className='logout' >LOGOUT</Button>
